...
export function PositionsMock() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-space-light rounded-xl p-6 border border-gray-200 dark:border dark:border-gray-800">
      <h4 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Open Positions</h4>
      ...
      <div className="space-y-4">
        {positions.map((position) => (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 text-sm mt-3 pt-3 border-t border-gray-300 dark:border-t dark:border-gray-800">
              <div>
                <span className="text-gray-600 dark:text-gray-500">Size:</span>
                <span className="text-gray-700 dark:text-gray-300 ml-2">{position.size}</span>
              </div>
              <div>
                <span className="text-gray-600 dark:text-gray-500">Entry:</span>
                <span className="text-gray-700 dark:text-gray-300 ml-2">{position.entryPrice}</span>
              </div>
              <div>
                <span className="text-gray-600 dark:text-gray-500">Mark:</span>
                <span className="text-gray-700 dark:text-gray-300 ml-2">{position.markPrice}</span>
              </div>
